        ...
        <main className="flex  min-h-screen flex-col items-center m-auto ">
            ...
            <div className="max-w-[1200px] min-h-[500px]  grid grid-cols-[1fr_2fr] mt-16 px-6 max-md:flex flex-col ">
                ...
                <div className="grid grid-rows-[2fr_1fr] justify-center">
                    <img src='../../../src/assets/imgs/logoLib.svg' alt='logoLib' />
                    <div className="flex justify-center items-start">
                        <img src='../../../src/assets/imgs/reactjs_logo.svg' alt='reactjs_logo' />
                        <img src='../../../src/assets/imgs/vitejs_logo.svg' alt='vitejs_logo' />
                        <img src='../../../src/assets/imgs/nextjs_logo.svg' alt='nextjs_logo' />
                    </div>
                </div>
                <div className=" grid grid-rows-[2fr_1fr] max-sm:grid-rows-1 ">
                    ...
                    <div className="flex justify-around items-start max-sm:flex-col max-sm:mb-12 gap-5">
                        <a href="/gettingstart" className="h-[70px] w-[30%] border-2 rounded-full bg-[#737384] flex items-center justify-center max-sm:w-full" >Getting Start</a>
                        <a href="/iconstack" className="h-[70px] w-[30%] border-2 rounded-full flex items-center justify-center max-sm:w-full">Icon Stacks</a>
                        <a href="/iconsproject" className="h-[70px] w-[30%] border-2 rounded-full  flex items-center justify-center max-sm:w-full">Icon Projects</a>
                    </div>
                </div>
            </div>
