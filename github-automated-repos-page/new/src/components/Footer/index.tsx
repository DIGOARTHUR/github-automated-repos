        ...
        <footer className="w-full bg-[#3D3D4D] font-sans pb-10">
            <div className="grid grid-cols-2  xl:grid-cols-4 gap-x-12 gap-y-8 max-w-7xl mx-auto p-10">
                ...
                <div className="flex flex-col gap-2">
                   ...
                   <div className="flex gap-1.5 ">    <img src='../../../src/assets/imgs/github_icon.svg' alt='npm_icon' /> <span >GitHub</span></div>
                 
                   <div className="flex gap-1.5 ">    <img src='../../../src/assets/imgs/npm_icon.svg' alt='npm_icon' /> <span >NPM</span></div>
                </div>
            </div>
        </footer>
    )
