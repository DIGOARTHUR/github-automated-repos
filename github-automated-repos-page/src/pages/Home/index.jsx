    ...
    <div className="home_Container">
      ...
      <main className="home_Content">
        ...
        <div className="button_Content">
          <Link
            className="button_effect button_effect-2"
        ...
        <div className="cards_Container">
          <div data-aos="fade-on" className="cards_Content">
            <div
              data-aos="fade-left"
              id="control_your_repositories"
              className="card_example"
            >
              <h1>Control your projects</h1>
              <p>
                Decide which project will be viewed on your personal page from a
                keyword determined by you.
              </p>
            ...
            <div data-aos="fade-right" className="card_example">
              ...
              <p>
                Customize, show what your project is about and what technologies
                you used.
              </p>
            ...
            <div data-aos="fade-left" className="card_example">
              <h1>In one place</h1>
              <p>
                Manage everything in the same place where you keep your project
                code. In just one field.
              </p>
