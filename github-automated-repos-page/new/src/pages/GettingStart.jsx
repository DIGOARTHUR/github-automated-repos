                ...
                <article className=" h-full  pt-8  mt-16 ml-[340px] px-6 pr-56  max-lg:ml-0 max-lg:pr-6">
                    ...
                    <div >
                        ...
                        <div className="ml-8">
                            ...
                            <br />
                            <br />
                            <img className="" src='../../../src/assets/imgs/fill_website.png' alt='logoLib' />
                            <br />
                            <br />
                            ...
                            <br />
                            <br />
                            <img className="" src='../../../src/assets/imgs/fill_topics.png' alt='logoLib' />
                            <br />
                            <br />
                            ...
                            <br />
                            <br />
                            <img className="" src='../../../src/assets/imgs/fill_repositoryName.png' alt='logoLib' />
                            <br />
                            <br />
                            ...
                            <br />
                            <br />
                            <img className="" src='../../../src/assets/imgs/fill_description.png' alt='logoLib' />
                        </div>
