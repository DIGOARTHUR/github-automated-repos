                        ...
                        {stackIconValues.length > 0 ? (
                            ...
                            <div className='flex flex-col m-auto gap-4'>
                                <p className='text-xl text-center'>
                                    ...
                                    <Link className='flex gap-2 text-[#00979C] justify-center' href='https://github.com/DIGOARTHUR/github-automated-repos/issues/new?assignees=&labels=&template=2-feature-request.yaml'>
